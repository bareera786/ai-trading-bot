...
echo "🔄 Step 1: Stopping all containers (as root)..."
...
echo "docker stop ai-trading-bot-prod trading-bot-postgres trading-bot-redis trading-bot-nginx 2>/dev/null || true"
echo "docker rm ai-trading-bot-prod trading-bot-postgres trading-bot-redis trading-bot-nginx 2>/dev/null || true"
...
if $SSH_ROOT_CMD "echo 'Root access confirmed'" 2>/dev/null; then
    ...
    $SSH_ROOT_CMD "docker stop ai-trading-bot-prod trading-bot-postgres trading-bot-redis trading-bot-nginx 2>/dev/null || true"
    $SSH_ROOT_CMD "docker rm ai-trading-bot-prod trading-bot-postgres trading-bot-redis trading-bot-nginx 2>/dev/null || true"
    ...
    echo "✅ Root-level containers and processes stopped"
else
...
if $SSH_CMD "echo 'aibot access confirmed'" 2>/dev/null; then
    ...
    $SSH_CMD "docker stop ai-trading-bot-prod trading-bot-postgres trading-bot-redis trading-bot-nginx 2>/dev/null || true"
    $SSH_CMD "docker rm ai-trading-bot-prod trading-bot-postgres trading-bot-redis trading-bot-nginx 2>/dev/null || true"

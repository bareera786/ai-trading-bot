...
4. Update deployment scripts (`deploy_to_vps_complete.sh`, Docker Compose flow) to run `npm install && npm run build` before syncing files, ensuring hashed assets are always published.

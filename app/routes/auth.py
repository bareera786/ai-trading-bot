...
def login():
    ...
    if request.method == 'POST':
        ...
        if user and user.check_password(password):
            ...
            response = redirect(next_page) if next_page else redirect(url_for('dashboard_bp.dashboard'))
    ...
    return render_template('auth/login.html', analytics=marketing_analytics_context())
...
def register():
    ...
    return render_template('auth/register.html', analytics=marketing_analytics_context())

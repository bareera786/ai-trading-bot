...
# Patch login_required before importing routes
...
class TestTradingStatus:
    ...
    def test_trading_status_unauthenticated(self, client):
        ...
        # Authentication is bypassed in tests, so should return 200
        assert response.status_code == 200

    def test_trading_status_authenticated(self, client):
...
class TestSpotToggle:
    ...
    def test_spot_toggle_enable(self, client, mock_context):
    ...
    def test_spot_toggle_disable(self, client, mock_context):
    ...
    def test_spot_toggle_toggle_mode(self, client, mock_context):
    ...
    def test_spot_toggle_missing_traders(self, client, mock_context):
...
class TestFuturesToggle:
    ...
    def test_futures_toggle_enable(self, client, mock_context):
    ...
    def test_futures_toggle_disable(self, client, mock_context):
    ...
    def test_futures_toggle_missing_traders(self, client, mock_context):
...
class TestSpotTrade:
    ...
    def test_spot_trade_success(self, client, mock_context):
    ...
    def test_spot_trade_missing_symbol(self, client, mock_context):
    ...
    def test_spot_trade_invalid_side(self, client, mock_context):
    ...
    def test_spot_trade_execution_failure(self, client, mock_context):
...
class TestFuturesTrade:
    ...
    def test_futures_trade_success(self, client, mock_context):
    ...
    def test_futures_trade_missing_parameters(self, client, mock_context):
    ...
    def test_futures_trade_execution_failure(self, client, mock_context):
...
class TestBinanceCredentials:
    ...
    def test_binance_credentials_get_success(self, client, mock_context):
...
class TestFuturesDashboard:
    ...
    def test_futures_dashboard_success(self, client, mock_context):

        ...
        with app.app_context():
            ...
            with app.test_client() as client:
                ...
                login_response = client.post(
                    "/login", json={"username": admin_username, "password": "admin123"}
                )
                ...
                if login_response.status_code == 200:
                    ...
                    print(
                        f"User creation response status: {user_creation_response.status_code}"
                    )
                    print(
                        f"User creation response data: {user_creation_response.get_json()}"
                    )
                    ...
                    if user_creation_response.status_code == 201:
                        ...
                        if user:
                            ...
                            print(
                                f"User details: {user.username}, {user.email}, admin: {user.is_admin}"
                            )

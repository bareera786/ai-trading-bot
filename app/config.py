...
class Config:
    ...
    ASSET_MANIFEST_PATH = os.getenv('ASSET_MANIFEST_PATH') or str(STATIC_DIST_DIR / 'manifest.json')
    ASSET_FALLBACKS = {
    ...
    PUBLIC_SUBSCRIPTION_CACHE_SECONDS = int(os.getenv('PUBLIC_SUBSCRIPTION_CACHE_SECONDS', '120'))

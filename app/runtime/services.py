...
from .indicators import BEST_INDICATORS, build_indicator_dashboard_refresher, IndicatorSelectionManager
...
def build_service_runtime(
	*,
	...
	realtime_update_service = RealtimeUpdateService(socketio, dashboard_data, get_active_trading_universe)
	...
	self_improvement_worker = SelfImprovementWorker(
		...
		dashboard_data=dashboard_data,
		trading_config=trading_config,
		cycle_interval_seconds=trading_config.get('self_improvement_interval_seconds', 10800.0),
		logger=bot_logger,
	)

...
def evaluate_symbol(symbol: str, payload: Dict, thresholds: Thresholds) -> Iterable[Breach]:
...
def parse_args(argv: List[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate backtest health report thresholds.")
    parser.add_argument(
        "report",
        type=Path,
        nargs="?",
    ...
    parser.add_argument("--symbols", nargs="*", help="Optional explicit list of symbols to validate.")
    parser.add_argument(
        "--min-total-return",
        type=float,

...
echo ""
cat << 'ROOT_COMMANDS'
systemctl stop ai-trading-bot 2>/dev/null || true
systemctl disable ai-trading-bot 2>/dev/null || true
rm -f /etc/systemd/system/ai-trading-bot.service
...
echo "- Stops all systemd services (root level)"

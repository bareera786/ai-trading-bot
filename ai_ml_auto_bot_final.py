...
TRADING_CONFIG = {
    "confidence_threshold": 0.40,  # Lowered from 0.58 to allow current strong signals
    "max_positions": 3,
    "take_profit": 0.08,
    "stop_loss": 0.03,
...
class UltimateMLTrainingSystem:
    def __init__(self, models_dir: Optional[str] = None, profile_key="ultimate"):
        ...
        self.timescaledb_service = None  # For efficient candle data storage
        print(
    ...
    def get_real_historical_data(self, symbol, years=1, interval="1d"):
        ...
        try:
            ...
            if (
                ...
                and self.timescaledb_service.is_available()  # type: ignore
            ):
                cached_data = self.timescaledb_service.get_candles(  # type: ignore
            ...
            if (
                ...
                stored_count = self.timescaledb_service.store_historical_data(  # type: ignore
                    symbol, interval, df
                )
                if stored_count > 0:
                    self.log_training(
...
if "pytest" not in sys.modules and not os.environ.get("PYTEST_CURRENT_TEST") and __name__ == "__main__":
